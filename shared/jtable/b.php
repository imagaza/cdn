...
var table = new Tabulator("#example-table", {
    ...
    columns:[
           {title:"Name", field:"id",  sorter:"string", width:200, headerFilter:"input", formatter:function(cell, formatterParams){
       var value = cell.getValue();
        return "<a href='"+ value +"'>" + value + "</a> <a href='"+ value +"'>Düzenle</a> <a href='"+ value +"'>Düzenle</a> <a href='"+ value +"'>Düzenle</a>";
        ...
        {title:"Name", field:"name",  sorter:"string", width:200, headerFilter:"input", formatter:function(cell, formatterParams){
       var value = cell.getValue();
