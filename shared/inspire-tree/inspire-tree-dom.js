...
var EditToolbar = function (_Component) {
	...
	createClass(EditToolbar, [{
		...
		value: function add(event) {
			...
			if(typeof window[this.props.dom._tree.config.editing.add] == 'function'){
				window[this.props.dom._tree.config.editing.add](this.props);
				return false;
			}
			if(this.props.dom._tree.config.editing.add instanceof Function){
				this.props.dom._tree.config.editing.add(this.props);
				return false;
			}
		...
		value: function edit(event) {
			event.stopPropagation();
			if(typeof window[this.props.dom._tree.config.editing.edit] == 'function'){
				window[this.props.dom._tree.config.editing.edit](this.props);
				return false;
			}
			if(this.props.dom._tree.config.editing.edit instanceof Function){
				this.props.dom._tree.config.editing.edit(this.props);
				return false;
			}
		...
		value: function remove(event) {
			event.stopPropagation();
			if(typeof window[this.props.dom._tree.config.editing.remove] == 'function'){
				window[this.props.dom._tree.config.editing.remove](this.props);
				return false;
			}
			if(this.props.dom._tree.config.editing.remove instanceof Function){
				this.props.dom._tree.config.editing.remove(this.props);
				return false;
			}
		...
		value: function remove(event) {
			event.stopPropagation();
			if(typeof window[this.props.dom._tree.config.editing.categoryChange] == 'function'){
				window[this.props.dom._tree.config.editing.categoryChange](this.props);
				return false;
			}
			if(this.props.dom._tree.config.editing.categoryChange instanceof Function){
				this.props.dom._tree.config.editing.categoryChange(this.props);
				return false;
			}
		}
	}, {
		...
		value: function render() {
			...
			if (this.props.dom._tree.config.editing.categoryChange) {
				buttons.push(createVNode$5(2, 'a', 'btn icon icon-category', null, {
...
var NodeAnchor = function (_Component) {
	...
	createClass(NodeAnchor, [{
		...
		value: function render() {
			...
			if(node.custom){
				ccontent[1] = " - ";
				ccontent[2] = createVNode$7(2, 'span', 'xmlCatTreeCustom '+node.custom.class, node.custom.text,{});
			}

			return createVNode$7(2, 'a', null, ccontent, _extends({
				'data-uid': node.id,
...
var ListItem = function (_Component) {
	...
	createClass(ListItem, [{
		...
		value: function renderEditToolbar() {
			...
			if (this.props.dom._tree.config.editable && !this.props.node.editing()) {
...
var List = function (_Component) {
	...
	createClass(List, [{
		...
		value: function render() {
			...
			return createVNode$2(2, 'ol', 'xmlCatTree', [items, this.props.children]);
		}
	}]);
	return List;
}(infernoComponent);
